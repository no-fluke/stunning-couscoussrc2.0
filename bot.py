...
from config import API_ID, API_HASH, BOT_TOKEN, LOG_CHANNEL, KEEP_ALIVE_URL, DB_URI, DB_NAME, DOWNLOAD_PATH
...
def create_directories():
    ...
    try:
        ...
        os.chmod(str(main_dir), 0o755)
        
        # Create temporary batch downloads directory
        ...
        os.chmod(str(thumbs_dir), 0o755)
        
        logger.info(f"Created directories: {main_dir}, {temp_dir}, {thumbs_dir}")
    except Exception as e:
